...
def modA(hp):
    ...
    units = hp.Int('units', min_value=64, max_value=256, step=64, default=128)
    ...
    out = tf.keras.layers.Dense(units, activation='relu', kernel_regularizer='l2')(out)
...
if __name__ == '__main__':
    ...
    tuner = kt.Hyperband(hypermodel=modA,
                        objective='val_loss',
                        max_epochs=50,
